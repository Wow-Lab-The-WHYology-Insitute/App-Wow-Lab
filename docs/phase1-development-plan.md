...
**Ultima verificare:** 2026-08-07 (decizie finală pe gate-ul de securitate WS-D — risc asumat conștient)
...
2. **Modulul de Costuri Admin** — apărut din răspunsul Laurei, adăugat ca schelet în machetă și notat în progress.md #25, dar **nu are încă task Asana** (și l-am oferit data trecută, n-am primit confirmare).
